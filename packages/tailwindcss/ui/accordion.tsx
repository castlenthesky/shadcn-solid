	...
	return (
		<AccordionPrimitive.Header class="flex" as="div">
			<AccordionPrimitive.Trigger
				...
				class={cn(
					"flex flex-1 items-start justify-between gap-4 py-4 text-sm font-medium transition-shadow hover:underline focus-visible:outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] rounded-md [&[data-expanded]>svg]:rotate-180",
					local.class,
				)}
				{...rest}
			>
